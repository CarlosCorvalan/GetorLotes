// GestorLotes Campo - Service Worker v2
const CACHE_NAME = 'gestorLotes-v2';

// All external resources to cache on install
const PRECACHE = [
  '/',
  '/index.html',
...
self.addEventListener('install', function(event) {
  event.waitUntil(
    caches.open(CACHE_NAME).then(function(cache) {
      ...
      // Cache each resource individually, don't fail if one misses
...
// Fetch: cache-first for local, network-first for tiles/APIs
